...
struct SettingsResetTests {
    ...
    @Test func resetRestoresEveryScalarKey() {
        ...
        d.set(KineticNotchSource.gpu.rawValue, forKey: StorageKey.kineticNotchSource)
        ...
        #expect(d.string(forKey: StorageKey.kineticNotchSource) == Defaults.kineticNotchSource.rawValue)
